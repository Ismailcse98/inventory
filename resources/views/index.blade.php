            ...
            <div class="media">
                ...
                <div class="media-body align-self-center">
                    <div class="text-right">
                        <h4 class="font-20 my-0 font-weight-bold"><span data-plugin="counterup">2</span></h4>
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card-box">
            <div class="media">
                ...
                <div class="media-body align-self-center">
                    <div class="text-right">
                        <h4 class="font-20 my-0 font-weight-bold"><span data-plugin="counterup">3</span></h4>
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card-box">
            <div class="media">
                ...
                <div class="media-body align-self-center">
                    <div class="text-right">
                        <h4 class="font-20 my-0 font-weight-bold"><span data-plugin="counterup">5</span></h4>
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card-box">
            <div class="media">
                ...
                <div class="media-body align-self-center">
                    <div class="text-right">
                        <h4 class="font-20 my-0 font-weight-bold"><span data-plugin="counterup">24</span></h4>
